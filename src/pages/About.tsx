        ...
        <div>
          ...
          <div className="mt-8">
            <img
              src={leafBg}
              alt=""
              className="absolute -z-10 mx-[4rem] brightness-75 w-[55%] top-64"
            />
            <img src={greenLeaf} alt="Leaf" className="mx-auto w-[85%]" />
          </div>
          <div className="bg-[#24ff02] w-[30%] h-[485.93px] left-[30%] top-[20%] opacity-[0.35] filter blur-[84.03px] rotate-[35.24deg] absolute -z-20"></div>
          <div className="bg-[#fcff45] w-20 h-20 rounded-full flex items-center justify-center p-4 relative left-20 bottom-24">
